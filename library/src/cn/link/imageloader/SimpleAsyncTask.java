...
public abstract class SimpleAsyncTask<Params, Progress, Result> {
    ...
    private static final BlockingQueue<Runnable> sWorkQueue = new LinkedBlockingQueue<Runnable>(8);
        ...
        mFuture = new FutureTask<Result>(mWorker) {
            ...
            protected void done() {
                ...
                try {
                    ...
                    message = sHandler.obtainMessage(MESSAGE_POST_CANCEL, new AsyncTaskResult<Result>(
                ...
                message = sHandler.obtainMessage(MESSAGE_POST_RESULT, new AsyncTaskResult<Result>(SimpleAsyncTask.this,
                        result));
                message.sendToTarget();
            }
        };
